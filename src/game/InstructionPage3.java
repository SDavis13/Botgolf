 ...
 * @extends		View
 */
public class InstructionPage3 extends View {
	static InstructionPage3 page = new InstructionPage3(Consts.GAMEMENUPAGE);
	 ...
	 */
    protected InstructionPage3(String name) {
        super(name);
	 ...
	 */
    public static InstructionPage3 getInstance(){
        return page;
    }
